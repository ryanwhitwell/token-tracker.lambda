...
namespace Token.BusinessLogic
{
  public class IntentRequestRouter : IRequestRouter
  {
    ...
    public IntentRequestRouter(ILogger<IntentRequestRouter> logger)
    {
      if (logger is null)
      {
    ...
    public SkillResponse AddPlayer(SkillRequest skillRequest, TokenUser tokenUser)
    {
      ...
      string playerName = IntentRequestRouter.TEXT_INFO.ToTitleCase(intentRequest.Intent.Slots["player"].Value);
